...
This plugin registers a new sidebar widget to be used on the ADMIN SIDE ONLY. When active it replaces the WP Welcome Panel Dashboard Widget. Inspired by and good for use with Dashboard Widget Sidebar, Dashboard Notes, Magic Widgets, and Enhanced Text Widget For completly "widgetizing" the wordpress admin. 
